...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm-call-js-from-rust.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm-call-js-from-rust.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm-call-js-from-rust.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm-call-js-from-rust.js.mem" : null;
...
Module['wasmTableSize'] = 188;

Module['wasmMaxTableSize'] = 188;
